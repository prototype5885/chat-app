class MemberListClass {
    ...
    addMember(userID, displayName, picture, online, status, statusText) {
        ...
        if (picture === "") {
            ...
            picture = main.getAvatarFullPath(picture)
        }
    ...
    changeStatusValueInMemberList(userID, newStatus) {
