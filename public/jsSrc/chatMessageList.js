class ChatMessageListClass {
    ...
    static ChatLoadingIndicator = document.getElementById('chat-loading-indicator')
    static ChatMessagesList = document.getElementById('chat-message-list')
    static SomeoneTyping = document.getElementById('someone-typing')
    static SvgContainer = document.getElementById('svg-container')
    ...
    static init() {
        this.ChatMessagesList.addEventListener('scroll', async () => {
            if (!MainClass.reachedBeginningOfChannel && this.ChatMessagesList.scrollTop < 200) {
    ...
    static async chatMessageReceived(json) {
        ...
        if (MainClass.getScrollDistanceFromBottom(this.ChatMessagesList) < 200 || json.IDu === MainClass.getOwnUserID()) {
    ...
    static async chatHistoryReceived(json) {
        ...
        if (json[1].length !== 0) {
            ...
            if (MainClass.getCurrentChannelID() === MainClass.lastChannelID) {
                ...
                MainClass.reachedBeginningOfChannel = true
            } else {
