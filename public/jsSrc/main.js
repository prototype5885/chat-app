class ColorsClass {
    static mainColor = 'rgb(54, 57, 63)'
    static hoverColor = 'rgba(128, 128, 128, 0.07)'
    static bitDarkerColor = 'rgb(43, 45, 49)'
    static darkColor = 'rgb(35, 36, 40)'
    static darkerColor = 'rgb(30, 31, 34)'
    static grayTextColor = 'rgb(148, 155, 164)'
    static darkTransparent = 'rgba(17, 18, 20, 0.82)'
    static darkNonTransparent = 'rgb(17, 18, 20)'
    static brighterTransparent = 'rgba(101, 101, 101, 0.82)'
    static loadingColor = 'rgba(0, 0, 0, 0.71)'
    static selectedColor = 'rgba(255, 255, 255, 0.05)'
    static separatorColor = 'rgba(255, 255, 255, 0.1)'
    static replyColor = 'rgba(255, 192, 0, 0.07)'
